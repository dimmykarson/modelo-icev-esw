...
\input{1_resumos/resumo}

\input{2_introducao/introducao}

\input{3_trabalhosrelacionados/relatedwork}

\input{4_metodologia/index}

\input{5_abordagem/index}

\input{6_experimentos/index}

\input{7_resultados/index}

\input{8_discussao/index}

\input{9_conclusao/index}
